<template>
    <div class="ratings hcreen bg--800">
        ...
        <ul class="grid lg:grid-cols-2 grid-cols-1 gap-8 p-4 text-">
            <li class="border border-gray-100 shadow-xs md:p-7 p-3 flex items-center justify-between w-full" v-for="(player, index) in injuries" :key="index">
